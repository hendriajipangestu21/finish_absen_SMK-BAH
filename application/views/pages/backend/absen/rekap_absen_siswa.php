<div class="card">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="col-md-6">
					...
					Kelas :
					<select id="kelas_id" name="kelas_id" class="form-control select2" id="" required>
						<option value="">----</option>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							...
							?>
							<a href="<?= base_url('admin/absen_siswa/cetak_rekap?filter_awal=' . $filter_awal . '&filter_akhir=' . $filter_akhir . '&kelas_id=' . $kelas_id . '') ?>" class="btn btn-info" type="button">Cetak</a>
						</div>
					</div>
				...
				<tbody>
					...
					?>
						<tr>
							<td><?= ($key + 1) ?></td>
							<td><?= $value->nama ?></td>
							<td><?= $value->nama_kelas . "/" . $value->kode_kelas ?></td>
	...
	<script>
		function filter() {
			...
			if (filter != "") {
				window.location = "<?= base_url("admin/absen_siswa/rekap_absen_siswa") ?>?filter_awal=" + filter_awal + "&&filter_akhir=" + filter_akhir + "&&kelas_id=" + kelas_id;
			}
		}
	</script>